...
import com.hafidtech.spring_ecommerce.repository.OrderRepository;
import com.hafidtech.spring_ecommerce.response.ApiResponse;
import com.hafidtech.spring_ecommerce.response.PaymentLinkResponse;
...
public class PaymentController {
    ...
    public ResponseEntity<PaymentLinkResponse> createPaymentLink(@PathVariable Long orderId,
        ...
        try {
            ...
            paymentLinkRequest.put("callback_url", "http://localhost:8081/payments/"+orderId);
